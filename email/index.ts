...
<mjml>
  ...
  <mj-body background-color="rgb(250, 250, 250)">
    ...
    <mj-text height="0px" color="rgb(250, 120,150)" font-weight="bold" font-size="15px" padding="10px" > Kliknij dopiero, kiedy będziesz pewny! :) </mj-text>
      ...
      <mj-column>
       <mj-button css-class="hover" href="http://localhost:3000/extended?email=me&rating=2"> 1 </mj-button>
      </mj-column>
      <mj-column> 
        <mj-button  href="http://localhost:3000/exntended?email=me&rating=2"> 2 </mj-button>
      </mj-column>
      <mj-column>
        <mj-button  href="http://localhost:3000/extended?email=me&rating=3"> 3 </mj-button>
      </mj-column>
      <mj-column>
        <mj-button  href="http://localhost:3000/extended?email=me&rating=4"> 4 </mj-button>
      </mj-column>
      <mj-column>
        <mj-button href="http://localhost:3000/extended?email=me&rating=5"> 5 </mj-button>
      </mj-column>
    </mj-section>
  </mj-body>
</mjml>
